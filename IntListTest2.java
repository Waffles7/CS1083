...
public class IntListTest2 {
 ...
 private static IntList2 list = new IntList2();
 //----------------------------------------------------------------
 ...
 public static void dispatch(int choice) {
   ...
   switch (choice) {
    ...
    case 4: //print
     ...
     break;
    case 5:
        System.out.println("The list in order recursively is: ");
        list.printRec();
     break;
    case 6:
        System.out.println("The list in reverse order recursively is: ");
 ...
 public static void printMenu() {
  ...
  System.out.println("5: Print the list in order using recursion");
  System.out.println("6: Print the list in reverse order using recursion");
  System.out.print("\nEnter your choice: ");
 }
}
